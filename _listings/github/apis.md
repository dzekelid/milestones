...
- name: Github Get Repos Owner Repo Milestones Number Labels
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/milestones/master/_listings/github/repos-owner-repo-milestones-number-labels-get-postman.md
x-common:
- type: x-net-library
